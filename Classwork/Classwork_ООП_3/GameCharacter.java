public class GameCharacter {
	...
	public void useSpecialAbility() {
		System.out.println(name + " uses a basic special ability!");
        if (mana >= 10) {
            mana -= 10;
            System.out.println("10 mana consumed. Remaining mana: " + mana);
        } else {
            System.out.println("Not enough mana! Need 10, but have only " + mana);
        }
    }
